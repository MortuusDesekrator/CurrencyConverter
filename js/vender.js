...
document.getElementById("dollar_venta").value = (valNum*73521.50).toFixed(2);
document.getElementById("paypal_venta").value = (valNum*65900.30).toFixed(2);
...
document.getElementById("airtm_venta").value = (valNum*66019.44).toFixed(2);
  }
}
